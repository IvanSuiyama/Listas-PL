...
var Pet = /** @class */ (function () {
    function Pet(connection) {
        this.connection = connection;
    }
    Pet.prototype.buscarPet = function (dbName) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.connection.query("USE ".concat(dbName, ";"), function (useError, _) {
                            if (useError) {
                                ...
                                _this.connection.query("SELECT * FROM pet", function (error, results) {
                                    if (error) {
    ...
    Pet.prototype.cadastrarPet = function (dbName, nome, raca, genero, tipo, donoCpf) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.connection.query("Use ".concat(dbName, ";"), function (useError, useResults) {
                            if (useError) {
                                ...
                                console.log("Banco de dados selecionado com sucesso");
                                _this.connection.query("INSERT INTO pet (nomePet, raca, genero, tipo, cpfDoDono) VALUES(?, ?, ?, ?, ?)", [nome, raca, genero, tipo, donoCpf], function (error, results) {
                                    if (error) {
